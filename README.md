...
2. Install all the libraries mentioned in the [requirements.txt](https://github.com/duha2001/Gorillas_Recommend_Movies/blob/main/requirements.txt) file with the command `pip install -r requirements.txt`
